...
def plot_mirdeep(candidates, candidate_to_miRNAid, candidate_to_dead, mirna_high_conf, mirdeep_candidates, name, isLog=False):
...
#         if param > -10: continue
        ...
        elif hashval in mirdeep_candidates:
