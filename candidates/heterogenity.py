...
#                 print seq.begin, five_begin+freq_range, seq.begin >= five_begin+freq_range
                feature_names = freq_range + seq.begin - five_begin
                begin_5s[feature_names] += count
                
                feature_names = freq_range + seq.end - five_end
                end_5s[feature_names] += count
                ...
                feature_names = freq_range + seq.begin - three_begin
                begin_3s[feature_names] += count
                
                feature_names = freq_range + seq.end - three_end
                end_3s[feature_names] += count
